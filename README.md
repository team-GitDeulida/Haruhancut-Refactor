...
> 위젯은 앱과 별도 프로세스에서 동작하고 서로의 샌드박스에 접근할 수 없기 떄문에
> 앱이 보유한 피드 데이터를 직접 읽을 수 없는 문제가 존재했다.
>
> **해결**  
...
> 4. 위젯 Provider는 오늘 날짜 폴더만 스캔하여 파일명 기준 최신 시간 1개 사진만 로딩
> 5. 이전 날짜 폴더는 자정에 자동 삭제되어 용량 안정성 확보
>
> **성과**    
